#' Create a data frame of general trends for 2010
#'
...
#' @return estDF
#' @export
general_trends_2010 <- function(trainingGrids,
...
#' Update data from PCA model predictions for 2010
#'
...
#'
#' @param trainingGrids dataframe; inital dataframe
#' @param estDF dataframe; created by general_trends()
#' @param BUCovars dataframe; dataframe of focal statistics for 3 variables with moving window (3,5,7,9)
#' @param pcaModel prcomp object; PCA model of BU data
#' @param selectedFeatures dataframe; selected features of model outputs
#' @param maskGrids dataframe; gridded mask data
#' @param popGrids2000 dataframe; gridded population data 2000
#' @importFrom stats predict
#' @return list; extracted components from update Grids data => list(bu_covars, selectedFeatures, estDF)
#' @export
update_pca_2010 <- function(trainingGrids,
                           estDF,
...
#' Create dataframe from list of GAM models for 2010
#'
...
#' @export
gam_dataframe_2010 <- function(ISO3ExceptList = "ISO3s_exceptions.csv",
                              selectedFeatures= "temp_SelectedFeatures_projection.RData",
                              ISO3List ="ISO3s.csv",
                              estDF,
