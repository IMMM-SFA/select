# TODO:  I was able to run this under the current settings
###### for 2010 ######
...
save(BUCovars, file = "/Users/d3y010/projects/jing/test/temp_tbl_attr_old.RData")
rm(BUCovars)
...
save(selectedFeatures, file = "/Users/d3y010/projects/jing/test/temp_SelectedFeatures_projection.RData")
...
save(estDF, file = "/Users/d3y010/projects/jing/test/temp_estDF.RData")
# load("temp_estDF.RData")

NatDecBUAmtList <- read.csv(paste0("/Users/d3y010/projects/jing/data/data_NationalBUAmts_", currSSP, ".csv"))
...
alloDF <- data.frame()
TPppBUList <- read.csv("/Users/d3y010/projects/jing/data/data_2000TPppBU.csv")
...
write.csv(alloDF, file = paste0("/Users/d3y010/projects/jing/test/tbl_inputToArcGIS_", currSSP, "_2010.csv"))
